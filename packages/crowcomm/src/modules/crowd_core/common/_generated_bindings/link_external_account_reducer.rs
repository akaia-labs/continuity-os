...
#[sats(crate = __lib)]
pub(super) struct LinkExternalAccountArgs {
	pub ext_account_id: String,
}

impl From<LinkExternalAccountArgs> for super::Reducer {
	fn from(args: LinkExternalAccountArgs) -> Self {
		Self::LinkExternalAccount {
			ext_account_id: args.ext_account_id,
		}
	}
}

impl __sdk::InModule for LinkExternalAccountArgs {
	type Module = super::RemoteModule;
}

pub struct LinkExternalAccountCallbackId(__sdk::CallbackId);

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `link_external_account`.
///
...
impl link_external_account for super::RemoteReducers {
	...
	fn on_link_external_account(
		...
		LinkExternalAccountCallbackId(self.imp.on_reducer(
			"link_external_account",
			Box::new(move |ctx: &super::ReducerEventContext| {
				let super::ReducerEventContext {
					event:
						__sdk::ReducerEvent {
							reducer: super::Reducer::LinkExternalAccount { ext_account_id },
							..
						},
					..
				} = ctx
...
impl set_flags_for_link_external_account for super::SetReducerFlags {
	fn link_external_account(&self, flags: __ws::CallReducerFlags) {
		self.imp
			.set_call_reducer_flags("link_external_account", flags);
	}
}
